$(function(){
    ...
    var musicNameData = ['HIP','NYA!!!','桜樹街道','望影の方舟Six','Igallta','Polaroid','アイドル(Idol)','Random(BOFXVII Team [Clue])'];                   // 歌曲名数组
    var artistNameData = ['MAMAMOO (마마무)','FLuoRiTe','Kozato Snow','Se-U-Ra','Se-U-Ra','Jonas Blue / Liam Payne / Lennon Stella','YOASOBI','Sobrem × Silentroom']           // 创作歌手数组
    var musicImgsData = []    // 图片地址数组
    var musicUrls=['mp3/music1.mp3','mp3/music2.mp3','mp3/music3.mp3','mp3/music4.mp3','mp3/music5.mp3','mp3/music6.mp3','mp3/music7.mp3','mp3/music8.mp3'];// 歌曲mp3数组
